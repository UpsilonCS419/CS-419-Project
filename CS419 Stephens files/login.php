...
header("location: testingsite.php");
}
...
<?php
		...
		if(isset($_POST['create'])){
			...
			if($check->num_rows>0){
				...
				$AddQuery = $con->prepare ("INSERT INTO user (email, password, fname, lname) VALUES ('$_POST[username]','$_POST[password]','$_POST[firstname]','$_POST[lastname]')");         
				echo '<script>
